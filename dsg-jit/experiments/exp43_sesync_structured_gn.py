"""
exp43_sesync_structured_gn.py

Experiment 43: Unbatched SE-Sync Structured GN with Self-Checking Inner
Solver and Cross-Seed Pooled Precision.
...
Run:
  python exp43_sesync_structured_gn.py --kitti-root /path/to/kitti --sigma-t 0.03
  python exp43_sesync_structured_gn.py --synthetic  # no KITTI needed
"""
...
def main():
    ...
    run_dir = os.path.join(args.output_dir, f"exp43_{run_ts}")
